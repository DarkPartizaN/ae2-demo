...
public class AfterEngine2DemoSE extends App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(StringUtils.concat("Width: ", width, "\nHeight: ", height));
    ...
    private static void enableLog() {
        ...
        try {
            //File to save
            File file = new File(StringUtils.concat(ResourceUtils.dir_root, "logs/"));
            if (!file.exists()) file.mkdir();
            file = new File(StringUtils.concat(ResourceUtils.dir_root, "logs/", "log_", date, ".txt"));
